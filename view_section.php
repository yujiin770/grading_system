...
<div class="container">
    ...
    <div class="card">
        ...
        <table>
            ...
            <tbody>
                <?php if (empty($enrolled_students)): ?>
                    <tr><td colspan="8">No students are enrolled in this section.</td></tr>
                <?php else: ?>
        ...
        <nav><ul class="pagination">
            <li class="<?php if($current_page <= 1){ echo 'disabled'; } ?>"><a href="?id=<?php echo $section_id; ?>&page=<?php echo $current_page - 1; ?>">Prev</a></li>
            <?php for($i = 1; $i <= $total_pages; $i++): ?>
            <li class="<?php if($current_page == $i) {echo 'active'; } ?>"><a href="?id=<?php echo $section_id; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
            <?php endfor; ?>
            <li class="<?php if($current_page >= $total_pages){ echo 'disabled'; } ?>"><a href="?id=<?php echo $section_id; ?>&page=<?php echo $current_page + 1; ?>">Next</a></li>
        </ul></nav>
        <?php endif; ?>
    </div>
